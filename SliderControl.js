L.Control.SliderControl = L.Control.extend({
    ...
    onAdd: function (map) {
        ...
        $(sliderContainer).append(
			'<div id="leaflet-slider" style="width:500px"><div class="ui-slider-handle"></div><div id="slider-timestamp" style="width:500px; margin-top:25px; background-color:#3498db; text-align:center; border-radius:5px;"></div></div>');
